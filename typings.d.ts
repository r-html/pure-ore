import { TemplateResult, async, render, RenderOptions, Component, CustomElementConfig, query, queryAll, LitElement, CSSResult } from '@rxdi/lit-html';

import { Subscribable, of, from, fromEvent, SchedulerLike, Observable } from 'rxjs';
import { queryParentRouterSlot } from 'router-slot';
import { ObservableInput, SchedulerLike, ObservedValueOf } from 'rxjs';
import { Operator } from 'rxjs';
import { Subscriber } from 'rxjs';
import { Subscription } from 'rxjs';
import { TeardownLogic, OperatorFunction, PartialObserver, Subscribable } from 'rxjs';
...
declare const html: TemplateResult;
declare const async: Subscribable<T> | PromiseLike<T>;
declare function render(result: TemplateResult, container: Element | DocumentFragment, options?: Partial<RenderOptions>): void;
declare function Component<T>(options: CustomElementConfig<T>):T;
declare function query(selector: string): (protoOrDescriptor: Object | ClassElement, name?: string | number | symbol) => any;
...
declare function css(strings: TemplateStringsArray, ...values: (number | CSSResult)[]): CSSResult;
...
declare function of<T, T2, T3, T4>(a: T, b: T2, c: T3, d: T4): Observable<T | T2 | T3 | T4>;
declare function of<T, T2, T3, T4, T5>(a: T, b: T2, c: T3, d: T4, e: T5): Observable<T | T2 | T3 | T4 | T5>;
declare function of<T, T2, T3, T4, T5, T6>(a: T, b: T2, c: T3, d: T4, e: T5, f: T6): Observable<T | T2 | T3 | T4 | T5 | T6>;
declare function of<T, T2, T3, T4, T5, T6, T7>(a: T, b: T2, c: T3, d: T4, e: T5, f: T6, g: T7): Observable<T | T2 | T3 | T4 | T5 | T6 | T7>;
declare function of<T, T2, T3, T4, T5, T6, T7, T8>(a: T, b: T2, c: T3, d: T4, e: T5, f: T6, g: T7, h: T8): Observable<T | T2 | T3 | T4 | T5 | T6 | T7 | T8>;
declare function of<T, T2, T3, T4, T5, T6, T7, T8, T9>(a: T, b: T2, c: T3, d: T4, e: T5, f: T6, g: T7, h: T8, i: T9): Observable<T | T2 | T3 | T4 | T5 | T6 | T7 | T8 | T9>;
...
declare type EventTargetLike<T> = HasEventTargetAddRemove<T> | NodeStyleEventEmitter | NodeCompatibleEventEmitter | JQueryStyleEventEmitter;
declare type FromEventTarget<T> = EventTargetLike<T> | ArrayLike<EventTargetLike<T>>;
...
declare function fromEvent<T>(target: FromEventTarget<T>, eventName: string): Observable<T>;
/** @deprecated resultSelector no longer supported, pipe to map instead */
declare function fromEvent<T>(target: FromEventTarget<T>, eventName: string, resultSelector: (...args: any[]) => T): Observable<T>;
declare function fromEvent<T>(target: FromEventTarget<T>, eventName: string, options: EventListenerOptions): Observable<T>;
/** @deprecated resultSelector no longer supported, pipe to map instead */
declare function fromEvent<T>(target: FromEventTarget<T>, eventName: string, options: EventListenerOptions, resultSelector: (...args: any[]) => T): Observable<T>;
